  ...
  return (
    <div className="space-y-16 px-6 py-12 max-w-7xl mx-auto">
      ...
      <section className="text-center py-20 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-2xl">
        <h1 className="text-4xl font-bold mb-4 text-indigo-700">Navigating the AI Landscape with Confidence</h1>
      ...
      <section className="grid md:grid-cols-2 gap-8 items-center">
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-indigo-600">Mission</h2>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-indigo-600">Vision</h2>
      ...
      {/* Team Section */}
      <section>
        <h2 className="text-3xl font-semibold text-center mb-8 text-indigo-700">Meet the Team</h2>
        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-8">
          {teamMembers.map((member) => (
            <div key={member.name} className="bg-white p-6 rounded-2xl shadow-lg hover:scale-105 transform transition">
              ...
              <h3 className="text-xl font-semibold text-center mt-4 text-indigo-600">{member.name}</h3>
      ...
      {/* Feature Summary */}
      <section>
        <h2 className="text-3xl font-semibold text-center mb-8 text-indigo-700">Key Features</h2>
      ...
      <section className="bg-gray-50 p-8 rounded-2xl">
        <h2 className="text-3xl font-semibold text-center mb-6 text-indigo-700">What Our Users Say</h2>
        <div className="space-y-6">
          {testimonials.map((t, idx) => (
            <blockquote key={idx} className="italic text-center text-gray-700">
              "{t.quote}"
              <footer className="mt-2 font-semibold text-indigo-600">— {t.author}</footer>
            </blockquote>
          ))}
        </div>
      </section>
